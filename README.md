...
The exocortex exists at three levels, each a different scope of shared context:
...
When working, you open your personal exocortex and symlink in the organization repo plus whichever project directories are active for you. Your agent then reads across all three levels to build its context.
