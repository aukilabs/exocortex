...
- Runtime-agnostic template landed with canonical bootstrap, state, memory, and skills files
...
- Resolve open design questions:
  ...
  - Should the org layer expose a shared `AGENTS.md`, a manifest, or only summary docs?
...
- Org-level context contract — shared summaries and policies that every agent can load without vendor lock-in
...
| Org-level context contract | Resolving method/value precedence design question |
